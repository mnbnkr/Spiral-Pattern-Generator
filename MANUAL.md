...
Custom finite color group is row index. Prime Knight color group is modulo bucket with a divisor normalized to a multiple of `6` at commit time. Prime Gapper color group is gap value.
